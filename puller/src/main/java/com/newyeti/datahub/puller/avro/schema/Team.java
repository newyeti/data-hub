 ...
 */
package com.newyeti.datahub.puller.avro.schema;
...
public class Team extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.newyeti.datahub.puller.avro.schema.Team.Builder newBuilder() {
    return new com.newyeti.datahub.puller.avro.schema.Team.Builder();
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static com.newyeti.datahub.puller.avro.schema.Team.Builder newBuilder(com.newyeti.datahub.puller.avro.schema.Team.Builder other) {
    return new com.newyeti.datahub.puller.avro.schema.Team.Builder(other);
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static com.newyeti.datahub.puller.avro.schema.Team.Builder newBuilder(com.newyeti.datahub.puller.avro.schema.Team other) {
    return new com.newyeti.datahub.puller.avro.schema.Team.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Team>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.newyeti.datahub.puller.avro.schema.Team.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.newyeti.datahub.puller.avro.schema.Team other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.datahub.puller.avro.schema.Team.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.datahub.puller.avro.schema.Team.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.datahub.puller.avro.schema.Team.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.datahub.puller.avro.schema.Team.Builder clearName() {
      name = null;
